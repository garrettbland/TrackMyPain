...
class Alert extends Component {
  ...
  render(){
    return(
      <Animatable.View animation={this.props.animation} style={{width:'100%',minHeight:50,backgroundColor:this.props.backgroundColor,marginBottom:12,borderRadius:4,overflow:'hidden',justifyContent:'center',paddingLeft:8,paddingTop:8,paddingBottom:8}}>
